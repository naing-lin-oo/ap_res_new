                    ...
                    <form action="{{ route('order.submit') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="card">
                                    <div class="card-body">
                                    <img src="{{ url('/images/'.$dish->image ) }}" width="188px" height="180px"><br>
                                    <label for="">{{ $dish->name }}</label><br>
                                    <input type="number" name="{{ $dish->id }}" class="form-control"><br><br>
                                    </div>
                                </div>
                            </div>
                            @endforeach
                        ...
                        <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <a href="/order/{{ $order->id }}/serve" class="btn btn-warning">Served</a>
